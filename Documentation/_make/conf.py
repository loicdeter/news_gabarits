# -*- coding: utf-8 -*-
#
# news_gabarits documentation build configuration file, created by
# TYPO3 extension sphinx on Wed, 03 Feb 2016 12:06:38 +0000.
#
...
project = u'news_gabarits'
copyright = u'2016, LoÃ¯c de Terwangne'
...
htmlhelp_basename = 'news_gabaritsdoc'
...
latex_documents = [
    ('Index', 'news_gabarits.tex', u'news_gabarits',
     u'LoÃ¯c de Terwangne', 'manual'),
]
...
pdf_documents = [
    ('Index', 'news_gabarits', u'news_gabarits',
     u'LoÃ¯c de Terwangne'),
]
...
texinfo_documents = [
    ('Index', 'news_gabarits', u'news_gabarits',
     u'LoÃ¯c de Terwangne', 'news_gabarits', 'One line description of project.',
     'Miscellaneous'),
]
